...
namespace SystemMartinezCV.Controllers
{
    public class ProyectosController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            ViewBag.sub = db.Subproyectos.ToList();
            ViewBag.detalles = db.DetalleProyectos.ToList();
            if (proyectos == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "IdProyecto,NumeroProyecto,Proyecto,Descripcion,IdCliente,MontoFinal,Costo,Ubicacion,FechaRegistro,FechaInicio,FechaFin,IdEmpleado,Comision,Rentabilidad,IdEstado")] Proyectos proyectos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdProyecto,NumeroProyecto,Proyecto,Descripcion,IdCliente,MontoFinal,Costo,Ubicacion,FechaRegistro,FechaInicio,FechaFin,IdEmpleado,Comision,Rentabilidad,IdEstado")] Proyectos proyectos)
        {
            if (ModelState.IsValid)
            {
